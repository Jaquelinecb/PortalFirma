...
public class FirmaPerfil4 {
	...
	//@Test(enabled=false)
	@Test(priority=1)
	  public void FirmaPerfil4HP() throws InterruptedException {
		driver.findElement(By.id("loginForm_user_login")).click();
		driver.findElement(By.id("loginForm_user_login")).sendKeys("Usuario4");//SQL
		//driver.findElement(By.id("loginForm_user_login")).sendKeys("Jaqueline");//ORACLE
		...
		driver.findElement(By.id("btnLogin")).click();
		Thread.sleep(1000);
		 //driver.findElement(By.cssSelector(".ui-dialog-buttonset > button")).click();//Para versión 4.6.21 o anterior
